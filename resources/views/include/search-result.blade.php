    ...
    <div class="container">
      <div class="row">
                    ...
                    <li>
                      <div class="filter-form__block center">
                        <form class="" method="post">
                          <h3 class="main-title">Affinez votre recherche</h3>
                          ...
                          <div class="filter-form__option">
                            <div class="filter-form__select">
                                ...
                                <div class="col">
                                  <p>Categorie</p>
                                  <select id="catalog-filter" class="form-control active" name="category_id">
                                ...
                                <div class="col">
                                  <p>Activité</p>
                                  <select id="subcatalog-filter" class="form-control active" name="subcategory_id">
                                ...
                                <div class="col">
                                  <p>Lieu</p>
                                  <select id="location-filter" class="form-control" name="filter_location">
                              ...
                              <button title="go" class="btn btn-primary filter-button" type="submit">
                                <span>
                                  <span>GO!</span>
                                </span>
                              </button>
        ...
        <div class="col-lg-9 col-sm-12">
          ...
          <div class="container">
            <div class="row">
            <div class="title-holder d-none-d-md-block">
                  <h1 class="base-title">Saut en parachute d'initiation</h1>
                  <div class="base-subtitle">
                    ...
                    <span class="subtitle">521 acitivities match your criteria</span>
                    <div class="sort-block">
                      <span class="text">Sort By:</span>
                      <div class="ah-select">
                        <select class="ais-SortBy__root">
              ...
              <div class="search-card col-lg-4 col-md-6">
                <div class="card z-depth-1">
                  ...
                  <div class="view overlay">
                    <img src="https://mdbootstrap.com/img/Photos/Lightbox/Thumbnail/img%20(147).jpg" class="card-img-top" alt="narrower">
                    <a>
                  ...
                  <div class=" card-body card-body-cascade">
                    <h5 class="card-title">
                      <i class="fas fa-euro-sign"></i> Culinary</h5>
                    <!--Title-->
                    <h4 class="card-title">Cheat day inspirations</h4>
                    <!--Text-->
                    <p class="card-text">Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid
                      ex ea commodi.
                    </p>
