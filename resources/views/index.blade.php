                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                            ...
                                            <ul class="nav navbar-nav navbar-right">
                                                ...
                                                <li><a href="#about"> Nos Terrains de jeu</a></li>
                                ...
                                <div class="main_home_slider text-center">
                                    <div class="single_home_slider">
                                        <div class="main_home wow fadeInUp" data-wow-duration="700ms">
                                          <h4>Réservation des activités extrêmes</h4>
                                           <!-- <h1>Dare to be reborn</h1> -->

                                            <div class="whiteseparator"></div>
                                            <div class="home_btn">
                                                <a href="" class="btn btn-primary">Toutes nos activités</a>
                                            </div>
                                        ...
                                        <div class="single_widget wow fadeIn" data-wow-duration="800ms">
                                            ...
                                            <div class="single_widget_blog">
                                                ...
                                                <div class="single_widget_content">
                                                    <p class="monseratregular">Lorem ipsum dolor sit amet, 
                                                        consectetur adipiscing</p>
                                                    <p class="robotolight">Jan 9, 2016</p>
                                                </div>
                                            </div>
                                            <div class="single_widget_blog">
                                                <div class="single_widget_img">
                                                ...
                                                <div class="single_widget_content">
                                                    <p class="monseratregular">Lorem ipsum dolor sit amet, 
                                                        consectetur adipiscing</p>
                                                    <p class="robotolight">Jan 9, 2018</p>
                                                </div>
                                            </div>
                                            <div class="single_widget_blog">
                                                <div class="single_widget_img">
                                        ...
                                        <div class="single_widget wow fadeIn" data-wow-duration="800ms">
                                            ...
                                            <div class="footer_gellary">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4 col-xs-6 no-padding">
                                                        <img src="assets/images/fg9.jpg" alt="" />
                                                    </div>
                                                </div> 
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <div class="copyright_text">
                                    <p class=" wow fadeInRight" data-wow-duration="1s">Made with <i class="fa fa-heart"></i> by FuriousDucks 2018. All Rights Reserved</p>
                                </div>
                            </div>
                        </div>
                    </div>
