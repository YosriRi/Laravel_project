                    		...
                    		<li>
                      			<div className="filter-form__block center">
                        			<form className="" method="post">
                          				<h3 className="main-title">Affinez votre recherche</h3>
                          				<div className="separator"></div>
                          				<div className="filter-form__option">
                            				<div className="filter-form__select">
                                				<div className="col">
                                  					<p>Categorie</p>
                                  					<select id="catalog-filter" className="form-control active" name="category_id">
                                    					<option value="0">Toutes les activités</option>
                                    					<option value="17">Avion </option>
                                    					<option value="165">Deltaplane </option>
                                    					<option value="36">Parapente </option>
                                    					<option value="181">Pilotage de Drone </option>
                                    					<option value="28">Planeur </option>
                                    					<option value="78">Saut à l'Élastique </option>
                                    					<option value="67">Saut en Parachute </option>
                                    					<option value="175">Simulateur de chute libre </option>
                                    					<option value="66">Simulateur de vol </option>
                                    					<option value="164">ULM </option>
                                    					<option value="83">Vol avec des Oiseaux </option>
                                    					<option value="69">Vol en Hélicoptère </option>
                                    					<option value="64">Vol en Montgolfière </option>
                                  					</select>
                                				</div>
                                				<div className="col">
                                  					<p>Activité</p>
                                  					<select id="subcatalog-filter" className="form-control active" name="subcategory_id">
                                    					<option value="0">Sous-catégorie</option>
                                    					<option value="150">Saut Parachute Tandem </option>
                                    					<option value="140">Saut d'initiation </option>
                                    					<option value="145">Stage parachute PAC </option>
                                  					</select>
                                				</div>
                                				<div className="col">
                                  					<p>Lieu</p>
                              						<select id="location-filter" className="form-control" name="filter_location">
                                						...
                                						<option value="d;haute-savoie-74aone-70">70 - Haute-Saône</option>
                            					...
                            					<div className="col">
                          						...
                          						<button title="go" className="btn btn-primary filter-button" type="submit">
                            						<span>
                              							<span>GO!</span>
                            						</span>
                          						</button>
